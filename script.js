...
function milesToOther(val){
    feet.value = val*5280;
    meter.value = val*63360;
    cm.value = val/0.0000062137;
    yard.value = val*0.1760;
...
function convertToOthers(convertFrom,value){
    switch(convertFrom){
        ...
        case "meter" : feetToOther(parseFloat(value)); break;
        case "inch" : feetToOther(parseFloat(value)); break;
        case "cm" : feetToOther(parseFloat(value)); break;
        case "yard" : feetToOther(parseFloat(value)); break;
        case "km" : feetToOther(parseFloat(value)); break;
        case "mile" : feetToOtherR(parseFloat(value)); break;
    }
}